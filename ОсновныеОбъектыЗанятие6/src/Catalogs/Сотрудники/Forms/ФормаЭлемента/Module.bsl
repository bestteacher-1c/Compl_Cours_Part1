...
Процедура ЗагрузитьФотоИзФайла(Команда)
	...
	, , , 
	,Новый ПараметрыДиалогаПомещенияФайлов("Выбирете файл для загрузки", Ложь)
...
&НаКлиенте
Процедура ЗагрузитьФотоИзФайлаЗавершение(ОписаниеФайла, ДополнительныеПараметры) Экспорт

	Если ОписаниеФайла <> Неопределено Тогда

		ФотоСотрудника = ОписаниеФайла.Адрес;
